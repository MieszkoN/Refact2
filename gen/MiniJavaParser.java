...
public class MiniJavaParser extends Parser {
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "INT", "BOOL", "Identifier", "WS"
		};
	}
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__9) | (1L << T__29) | (1L << T__35) | (1L << T__36) | (1L << Identifier))) != 0)) {
				{
				{
				setState(94);
				methodDeclaration();
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__9) | (1L << T__29) | (1L << T__35) | (1L << T__36) | (1L << Identifier))) != 0)) {
				{
				setState(154);
				formalParameterList();
				}
	...
	public final MethodArgumentListContext methodArgumentList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__8) | (1L << T__26) | (1L << T__27) | (1L << T__28) | (1L << T__34) | (1L << INT) | (1L << BOOL) | (1L << Identifier))) != 0)) {
				{
				setState(291);
				expression(0);
				setState(296);
