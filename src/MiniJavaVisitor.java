...
public interface MiniJavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#charType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCharType(MiniJavaParser.CharTypeContext ctx);
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#stringType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStringType(MiniJavaParser.StringTypeContext ctx);
}