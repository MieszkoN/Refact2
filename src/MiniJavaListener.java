// Generated from /home/mieszko/Pulpit/Test/Lab/Refact2/grammar/MiniJava.g4 by ANTLR 4.10.1
...
public interface MiniJavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#charType}.
	 * @param ctx the parse tree
	 */
	void enterCharType(MiniJavaParser.CharTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#charType}.
	 * @param ctx the parse tree
	 */
	void exitCharType(MiniJavaParser.CharTypeContext ctx);
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#stringType}.
	 * @param ctx the parse tree
	 */
	void enterStringType(MiniJavaParser.StringTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#stringType}.
	 * @param ctx the parse tree
	 */
	void exitStringType(MiniJavaParser.StringTypeContext ctx);
}